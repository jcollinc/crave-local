...
#Users
jon = User.create(name: "Jon", username: "jon@jon.com", password: "password", address: "456 Main", isRestaurant: false)
felipa = User.create(name: "Felipa", username: "felipa@felipa.com", password: "password", address: "456 Main", isRestaurant: false)
...
#Orders
order = Order.create(user:jon, restaurant:restaurant1, total: 10.0)
